...
/// <summary>
/// Data Transfer Object representing a vehicle assigned to a service program, including assignment metadata.
/// </summary>
public class ServiceProgramVehicleDTO
{
    ...
    /// <summary>
    /// The date and time when the vehicle was assigned to the service program.
    /// </summary>
    public required DateTime AddedAt { get; set; }

    // public string? AddedByUserID { get; set; } // For future use if assignment user tracking is implemented
}