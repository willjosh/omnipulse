...
namespace Persistence.Migrations
{
    ...
    [Migration("20250813041905_RemoveVehicleEngineHours")]
    partial class RemoveVehicleEngineHours
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Issue", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Title"), new[] { "Description", "Status", "PriorityLevel" });
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ReportedDate", "Status"), new[] { "PriorityLevel", "Category" });

                    b.HasIndex("ResolvedByUserID", "ResolvedDate")
                        .HasDatabaseName("IX_Issues_ResolvedByDateResolved");

                    b.HasIndex("ResolvedDate", "Status")
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Status", "ReportedDate"), new[] { "Title", "PriorityLevel", "Category", "VehicleID", "ReportedByUserID" });
                    ...
                    b.HasIndex("ReportedByUserID", "Status", "ReportedDate")
                        .HasDatabaseName("IX_Issues_UserStatusReported");

                    b.HasIndex("Status", "PriorityLevel", "ReportedDate")
                        .HasDatabaseName("IX_Issues_StatusPriorityReported");

                    b.HasIndex("VehicleID", "Status", "ReportedDate")
            ...
            modelBuilder.Entity("Domain.Entities.ServiceProgram", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsActive"), new[] { "Name" });
            ...
            modelBuilder.Entity("Domain.Entities.ServiceTask", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsActive"), new[] { "Name", "Category", "EstimatedLabourHours", "EstimatedCost", "Description" });
            ...
            modelBuilder.Entity("Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.HasIndex("AssignedTechnicianID")
                        ...
                        .HasFilter("AssignedTechnicianID IS NULL");
                    ...
                    b.HasIndex("LicensePlateExpirationDate", "Status")
                        .HasDatabaseName("IX_Vehicles_LicenseExpirationStatus");

                    b.HasIndex("Mileage", "Status")
                    ...
                    b.HasIndex("PurchasePrice", "Status")
                        .HasDatabaseName("IX_Vehicles_PurchasePriceStatus");

                    b.HasIndex("Status", "CreatedAt")
                        .HasDatabaseName("IX_Vehicles_StatusCreatedCovering");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Status", "CreatedAt"), new[] { "Name", "Make", "Model", "Year", "VehicleType", "VehicleGroupID", "AssignedTechnicianID", "Mileage" });

                    b.HasIndex("Status", "Mileage")
                        .HasDatabaseName("IX_Vehicles_StatusMileage");

                    b.HasIndex("VIN", "Status")
                        .HasDatabaseName("IX_Vehicles_VINStatus");

                    b.HasIndex("VehicleGroupID", "Name")
                        .HasDatabaseName("IX_Vehicles_GroupNameCovering");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("VehicleGroupID", "Name"), new[] { "Status", "Make", "Model", "Year", "Mileage" });

                    b.HasIndex("VehicleGroupID", "Status")
                    ...
                    b.HasIndex("VehicleGroupID", "Status", "Mileage")
            ...
            modelBuilder.Entity("Domain.Entities.VehicleGroup", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IsActive"), new[] { "Name", "Description" });
            ...
            modelBuilder.Entity("Domain.Entities.WorkOrder", b =>
                {
                    ...
                    b.HasIndex("ActualCompletionDate", "Status")
                        .HasDatabaseName("IX_WorkOrders_ActualCompletionStatus");

                    b.HasIndex("ActualStartDate", "Status")
                        .HasDatabaseName("IX_WorkOrders_ActualStartStatus");

                    b.HasIndex("AssignedToUserID", "ScheduledStartDate")
                    ...
                    b.HasIndex("EndOdometer", "Status")
                        .HasDatabaseName("IX_WorkOrders_EndOdometerStatus");

                    b.HasIndex("ScheduledCompletionDate", "Status")
                        .HasDatabaseName("IX_WorkOrders_ScheduledCompletionStatus");

                    b.HasIndex("ScheduledStartDate", "Status")
                        .HasDatabaseName("IX_WorkOrders_ScheduledStartStatusCovering");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ScheduledStartDate", "Status"), new[] { "PriorityLevel", "WorkOrderType" });

                    b.HasIndex("StartOdometer", "Status")
                        .HasDatabaseName("IX_WorkOrders_StartOdometerStatus");

                    b.HasIndex("Status", "CreatedAt")
                        .HasDatabaseName("IX_WorkOrders_StatusCreatedCovering");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Status", "CreatedAt"), new[] { "Title", "VehicleID", "AssignedToUserID", "PriorityLevel", "WorkOrderType", "ScheduledStartDate", "StartOdometer" });
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("VehicleID", "Status"), new[] { "Title", "PriorityLevel", "WorkOrderType", "ScheduledStartDate", "CreatedAt" });

                    b.HasIndex("WorkOrderType", "Status")
                        .HasDatabaseName("IX_WorkOrders_TypeStatus");

                    b.HasIndex("PriorityLevel", "Status", "ScheduledStartDate")
                        .HasDatabaseName("IX_WorkOrders_PriorityStatusScheduled");

                    b.ToTable("WorkOrders", null, t =>
                        {
                            t.HasCheckConstraint("CK_WorkOrder_ActualDates", "ActualCompletionDate IS NULL OR ActualStartDate IS NULL OR ActualCompletionDate >= ActualStartDate");

                            t.HasCheckConstraint("CK_WorkOrder_EndOdometer", "EndOdometer IS NULL OR EndOdometer >= StartOdometer");

                            t.HasCheckConstraint("CK_WorkOrder_ScheduledDates", "ScheduledCompletionDate IS NULL OR ScheduledStartDate IS NULL OR ScheduledCompletionDate >= ScheduledStartDate");
            ...
            modelBuilder.Entity("Domain.Entities.WorkOrderIssue", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("IssueID"), new[] { "WorkOrderID", "AssignedDate" });

                    b.HasIndex("WorkOrderID")
                        .HasDatabaseName("IX_WorkOrderIssues_WorkOrderCovering");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("WorkOrderID"), new[] { "IssueID", "AssignedDate" });

                    b.HasIndex("IssueID", "AssignedDate")
                        .HasDatabaseName("IX_WorkOrderIssues_IssueAssignedDate");

                    b.HasIndex("WorkOrderID", "AssignedDate")
            ...
            modelBuilder.Entity("Domain.Entities.WorkOrderLineItem", b =>
                {
                    ...
                    b.HasIndex("AssignedToUserID", "LaborHours")
                        .HasDatabaseName("IX_WorkOrderLineItems_UserLaborHours");

                    b.HasIndex("HourlyRate", "LaborHours")
                    ...
                    b.HasIndex("InventoryItemID", "Quantity")
                        .HasDatabaseName("IX_WorkOrderLineItems_InventoryItemQuantity");

                    b.HasIndex("ItemType", "TotalCost")
                        .HasDatabaseName("IX_WorkOrderLineItems_ItemTypeTotalCost");

                    b.HasIndex("ServiceTaskID", "CreatedAt")
                        .HasDatabaseName("IX_WorkOrderLineItems_ServiceTaskCreatedAtCovering");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ServiceTaskID", "CreatedAt"), new[] { "TotalCost", "LaborHours", "AssignedToUserID" });

                    b.HasIndex("ServiceTaskID", "LaborHours")
                        .HasDatabaseName("IX_WorkOrderLineItems_ServiceTaskLaborHours");

                    b.HasIndex("UnitPrice", "Quantity")
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("WorkOrderID", "ItemType"), new[] { "Quantity", "UnitPrice", "TotalCost", "LaborHours", "ServiceTaskID", "InventoryItemID" });

                    b.HasIndex("WorkOrderID", "TotalCost")
                        .HasDatabaseName("IX_WorkOrderLineItems_WorkOrderTotalCost");

                    b.HasIndex("WorkOrderID", "ItemType", "TotalCost")
            ...
            modelBuilder.Entity("Domain.Entities.XrefServiceProgramVehicle", b =>
                {
                    ...
                    b.HasIndex("ServiceProgramID", "AddedAt")
                        .HasDatabaseName("IX_XrefServiceProgramVehicles_ProgramAdded");

                    b.HasIndex("VehicleID", "AddedAt")
            ...
            modelBuilder.Entity("Domain.Entities.XrefServiceScheduleServiceTask", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ServiceScheduleID"), new[] { "ServiceTaskID" });
