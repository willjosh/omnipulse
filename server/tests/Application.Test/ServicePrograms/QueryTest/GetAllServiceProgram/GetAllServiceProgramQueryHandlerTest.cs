    ...
    private static List<ServiceProgram> CreateServicePrograms()
    {
        ...
        [
            new ServiceProgram
            {
                ...
                [
                    new XrefServiceProgramVehicle { ServiceProgramID = 1, VehicleID = 1, AddedAt = FixedDate, ServiceProgram = null!, Vehicle = null!, User = null! },
                    new XrefServiceProgramVehicle { ServiceProgramID = 1, VehicleID = 2, AddedAt = FixedDate, ServiceProgram = null!, Vehicle = null!, User = null! },
                    new XrefServiceProgramVehicle { ServiceProgramID = 1, VehicleID = 3, AddedAt = FixedDate, ServiceProgram = null!, Vehicle = null!, User = null! }
                ]
            },
            new ServiceProgram
            {
                ...
                XrefServiceProgramVehicles =
                [
                    new XrefServiceProgramVehicle { ServiceProgramID = 2, VehicleID = 4, AddedAt = FixedDate, ServiceProgram = null!, Vehicle = null!, User = null! }
                ]
            },
            new ServiceProgram
            {
